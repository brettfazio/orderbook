...
#define TEST(num, orders, execs) \
  ...
  correct += test(o##num, sizeof(o##num) / sizeof(t_order), x##num, sizeof(x##num) / sizeof(t_execution));
#define TEST_CANCEL(num, orders1, cancels, orders2, execs) \
  ...
  t_execution x##num[] = execs;                            \
  correct += test_cancel(o1st##num, sizeof(o1st##num) / sizeof(t_order), c##num, sizeof(c##num) / sizeof(t_orderid), o2nd##num, sizeof(o2nd##num) / sizeof(t_order), x##num, sizeof(x##num) / sizeof(t_execution));
